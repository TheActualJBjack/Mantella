...
class LLMDefinitions:
    ...
    def get_llm_api_config_value() -> ConfigValue:
        ...
        return ConfigValueSelection("llm_api","LLM Service",description, "OpenRouter", ["OpenRouter", "OpenAI", "Gemini", "KoboldCpp", "textgenwebui"], allows_free_edit=True)
    ...
    def get_model_config_value() -> ConfigValue:
        ...
        return ConfigValueSelection("model","Model",model_description,"gemini-2.5-flash",["Custom Model"], allows_values_not_in_options=True)
